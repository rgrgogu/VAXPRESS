      ...
      <div class="modal-content">
        ...
        <form id="rForm" name="rForm" action="./src/PHP DATABASE/ClientRegister.php" method="POST" required>
          <div class="modal-body">
            <div class="form-floating mb-3 text-danger text-justify">
              Note: Your e-mail address that you've enlisted in the day of your vaccination must be entered here in the Email Address input.
            </div>
            ...
            <div class="form-floating mb-3">
              <input type="text" class="form-control" name="txtRLastName" placeholder="Last Name" required />
              <label for="txtRLastName">Last Name</label>
            </div>
            <div class="form-floating mb-3">
              <input type="text" class="form-control" name="txtRGivenName" placeholder="Given Name" required />
              <label for="txtRGivenName">Given Name</label>
            </div>
            <div class="form-floating mb-3">
              <input type="text" class="form-control" name="txtRMiddleName" placeholder="Middle Name" required />
              <label for="txtRMiddleName">Middle Name</label>
            </div>
            <div class="form-floating mb-3">
              <input type="password" class="form-control" name="txtRPassword" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required />
              <label for="txtPassword">Password</label>
            </div>
            <div class="form-floating mb-3">
              <input type="password" class="form-control" name="txtRConfirm" placeholder="Confirm Password" required />
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="./src/PHP DATABASE/ForgotPassword.php" method="POST">
            ...
            <div class="form-floating mb-3">
              <input type="password" class="form-control" id="txtFPass" placeholder="Password" />
              <label for="txtFPassword">Password</label>
            </div>
            <div style="display: flex; justify-content: end">
              <button type="submit" class="btn btn-outline-danger" name="btnFSubmit" id="btnFUpdate">
                Update
              </button>
            </div>
          </form>
